...
<div class="site-index">
  <div id="box-shadow-object" style="height: 475px;margin-left: auto; margin-right:auto; padding: 10px; color: white;box-shadow: 10px 10px 5px 0px rgba(0, 0, 0, 0.75); background-color: rgb(51, 51, 51);">
...
<?php $form = ActiveForm::begin(['id' => 'answer-form', 'action'=> ['game/answer']]); ?>
	<p>
